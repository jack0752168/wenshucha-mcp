...
| Tool | 用途 |
| --- | --- |
| `search_judgments` | **全案由通用检索** —— 120万+ 中国裁判文书(借贷/合同/信用卡/交通事故/劳动/刑事…),按关键词 + 案由/省份/法院/年份过滤,返回标题/法院/案由/日期/案号 + 原文链接 |
| `search_cases` | **劳动争议专项** —— 案情文本 + 结构化过滤(省份/案由/解雇原因/工龄/年份)→ Top 20 类案 + 金额分位(p25/中位/p75)+ 关键裁判因素 |
